...
<aside class="client-sidebar" id="clientSidebar">
    ...
    <nav class="sidebar-navigation">
        ...
        <a href="dashboard.php?page=home" class="sidebar-link <?= $currentPage === 'home' ? 'active' : ''; ?>">
            <i class="fa-solid fa-house"></i>
            <span>Home</span>
        </a>

        <!-- FIND SERVICES -->
        <a href="dashboard.php?page=services" class="sidebar-link <?= $currentPage === 'services' ? 'active' : ''; ?>">
            <i class="fa-solid fa-magnifying-glass"></i>
            <span>Find Services</span>
        </a>

        <!-- BOOKINGS -->
        <a href="dashboard.php?page=bookings" class="sidebar-link <?= $currentPage === 'bookings' ? 'active' : ''; ?>">
            <i class="fa-solid fa-calendar-check"></i>
            <span>My Bookings</span>
        </a>

        <!-- FAVORITES -->
        <a href="dashboard.php?page=favorites" class="sidebar-link <?= $currentPage === 'favorites' ? 'active' : ''; ?>">
            <i class="fa-solid fa-heart"></i>
            <span>Favorites</span>
        </a>

        <!-- MESSAGES -->
        <a href="dashboard.php?page=messages" class="sidebar-link <?= $currentPage === 'messages' ? 'active' : ''; ?>">
